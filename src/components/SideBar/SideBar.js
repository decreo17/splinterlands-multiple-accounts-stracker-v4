...
export const SideBar = () => {
    ...
    return (
        <div className="w3-sidebar w3-bar-block w3-card w3-animate-left w3-dark-grey" style={{display:'none'}} id="my-sidebar"><br />
            <hr />
            <div className="w3-container">
                <h5>Dashboard</h5>
            </div>
            <div className="w3-bar-block">
                <a className="w3-bar-item w3-button w3-padding-16 w3-hide-large w3-hide-small w3-hide-medium w3-dark-grey w3-hover-black"
                    onClick={W3Close} title="close menu"><i><FontAwesomeIcon icon={faRemove} /></i>  Close Menu</a>
                <a href={url} className="w3-bar-item w3-button w3-padding w3-blue"><i><FontAwesomeIcon icon={faDashboard} /></i>  Main Dashboard</a>
                ...
                <a href={url} className="w3-bar-item w3-button w3-padding w3-blue">
                    <i><FontAwesomeIcon icon={faGlobe} /></i>  Net Income</a>
