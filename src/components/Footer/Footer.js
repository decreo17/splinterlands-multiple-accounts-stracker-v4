...
const Footer = () => {
    return (
      <>
        <footer id="main-footer" className="w3-container w3-padding-16 w3-dark-grey">
          <h5>
              ...
              <a href="https://m.me/DadeeGaming17" target="_blank" rel="noreferrer">m.me/DadeeGaming17</a><br />
